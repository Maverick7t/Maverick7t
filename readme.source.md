...
```aura width=1000 height=350
<div style={{width:'1000px',height:'350px',display:'flex',flexDirection:'column',padding:'28px 36px',boxSizing:'border-box',background:'#08090d',color:'#f8fafc',position:'relative',overflow:'hidden',borderRadius:'26px',border:'1px solid rgba(120,130,160,0.18)'}}>
  <div style={{display:'flex',alignItems:'center',justifyContent:'center',zIndex:10,marginBottom:'20px'}}>
    <span style={{fontSize:'14px',fontWeight:600,color:'#67e8f9',letterSpacing:'2.5px'}}>TECH STACK</span>
  </div>
  <div style={{display:'flex',flexDirection:'column',gap:'18px',zIndex:10,padding:'24px 28px',background:'rgba(12,14,20,0.68)',borderRadius:'20px',border:'1px solid rgba(255,255,255,0.11)',boxShadow:'0 24px 70px rgba(0,0,0,0.42),inset 0 1px 0 rgba(255,255,255,0.06)'}}>
    <div style={{display:'flex',alignItems:'center',justifyContent:'center'}}><img src="https://skillicons.dev/icons?i=python,django,fastapi,flask,go,cpp,ts,nodejs,express" height="42" /></div>
    <div style={{display:'flex',alignItems:'center',justifyContent:'center'}}><img src="https://skillicons.dev/icons?i=mysql,postgres,redis,mongodb" height="42" /></div>
    <div style={{display:'flex',alignItems:'center',justifyContent:'center'}}><img src="https://skillicons.dev/icons?i=pytorch,tensorflow" height="42" /><img src="https://cdn.simpleicons.org/langchain" height="38" /><img src="https://cdn.simpleicons.org/mlflow" height="38" /></div>
    <div style={{display:'flex',alignItems:'center',justifyContent:'center'}}><img src="https://skillicons.dev/icons?i=aws,azure,gcp,docker,kubernetes,githubactions,linux,git,github,postman,terraform" height="42" /></div>
  </div>
</div>
```
